package com.lenovo.vctl.apps.commons.utils.concurrent;
...
public class NotifyingBlockingThreadPoolExecutor extends ThreadPoolExecutor {
	 ...
	 * @see com.lenovo.vctl.apps.commons.utils.concurrent.NotifyingBlockingThreadPoolExecutor#await() for more details.
	...
	private class Synchronizer {
		 ...
		 * @see com.lenovo.vctl.apps.commons.utils.concurrent.NotifyingBlockingThreadPoolExecutor#await() for details.
		 * @throws InterruptedException when the internal condition throws it.
		 */
		public void await() throws InterruptedException {
		 ...
		 * @see com.lenovo.vctl.apps.commons.utils.concurrent.NotifyingBlockingThreadPoolExecutor#await(long, java.util.concurrent.TimeUnit) for details.
		 * @throws InterruptedException when the internal condition throws it.
		 */
		public boolean await(long timeout, TimeUnit timeUnit) throws InterruptedException {
