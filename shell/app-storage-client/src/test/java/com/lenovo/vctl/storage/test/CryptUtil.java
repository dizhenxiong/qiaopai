 ...
 */
     ...
     public static void main(String[] args) {
         try {
             String s = "{\"app_id\":\"003f142a4aeea000\",\"expiration\":1374869926,\"user_slug\":\"songkun1@lenovo.com\"}";
             ...
             key = initKey("85331d028f7dfd475e94207d12fbb9b9");
             System.out.println(ALGORITHM + "密钥:t" + key);
             c = encrypt(s.getBytes("UTF-8"), key);
             System.out.println(ALGORITHM + "   加密后:" + URLEncoder.encode(encryptBASE64(c)));
             c = decrypt(c, key);
